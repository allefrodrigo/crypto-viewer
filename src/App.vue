...
<body>
    <div class="container">
        <div class="mobile">
            ...
            <div class="content">
                <div class="total">
                    <div class="label">Total da carteira</div>
                    <div class="value">R$1869.14795</div>
                    <div class="balance">+ R$688,00</div>
                </div>
                <div class="cards">
                    <div class="card green">
                        <div class="item">
                            <div class="label">Litecoin</div>
                            <div class="value">R$635.60</div>
                        </div>
                        <div class="balance">
                            <div class="arrow-up">
                    ...
                    <div class="card magenta">
                        <div class="item">
                            ...
                            <div class="value">R$ 3.03</div>
                        </div>
                        <div class="balance">
                            <div class="arrow-up">
                                <i class="fas fa-arrow-up"></i>
                            </div>
                            <div class="value">89.89</div>
                        </div>
                    </div>
                    <div class="card gray">
                        <div class="item">
                            <div class="label">CHAINLINK</div>
                            <div class="value">R$3.17</div>
                        </div>
                        <div class="balance">
                            <div class="arrow-up">
                                <i class="fas fa-arrow-up"></i>
                     ...
                     <div class="card gray">
                        <div class="item">
                            <div class="label">CHILIZ</div>
                            <div class="value">R$1.46</div>
                        </div>
                        <div class="balance">
                            <div class="arrow-up">
                                <i class="fas fa-arrow-up"></i>
                     ...
                     <div class="card gray">
                        <div class="item">
                            <div class="label">WIBX</div>
                            <div class="value">R$ 0.09641</div>
                        </div>
                        <div class="balance">
                            <div class="arrow-up">
                                <i class="fas fa-arrow-up"></i>
                ...
                <div class="list">
                    <div class="item1">
                        <div class="section1">
                            ...
                            <div class="text">
                                ...
                                <div class="description">Hoje, 13:45</div>
                            </div>
                        </div>
                        <div class="section2">
                            <div class="signal negative">-</div>
                            <div class="value">R$ 292.37</div>
                        </div>
                    </div>
                    <div class="item2">
                        <div class="section1">
                        ...
                        <div class="section2">
                            ...
                            <div class="value">R$ 272.3667</div>
                        </div>
                    </div>
                    <div class="item3">
                        <div class="section1">
                    ...
                    <div class="item4">
                        <div class="section1">
                            ...
                            <div class="text">
                                <div class="title">Chiliz</div>
                                <div class="description">Hoje, 13:45</div>
                            </div>
                        </div>
                        <div class="section2">
                            <div class="signal positive">+</div>
                            <div class="value">R$ 474.50</div>
                        </div>
                    </div>
                </div>
            </div>
